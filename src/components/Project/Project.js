    ...
    <div className="container">
      ...
      <div className="content">
        ...
        <div className="list-view">
          ...
          <div className="filter-view">Filter:</div>
          <div className="list">
            Fetched data goes here example list item
            <div className="list-item">
              ...
              <div className="skill-list">{'required skills'}</div>
            </div>
          </div>
        </div>
        <div className="skill-view">Skill component</div>
      </div>
    </div>
  );
};
